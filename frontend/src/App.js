...
function App() {
  ...
  // Si el usuario es CLIENTE, mostramos SOLO el Portal del Cliente (pantalla completa)
  if (userRole === 'CLIENTE') {
    return (
      <div className="h-screen w-full relative">
         ...
         <button 
            ...
            className="absolute top-4 right-4 z-50 bg-red-100 hover:bg-red-200 text-red-600 px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-colors shadow-sm"
          >
  ...
  // Si el usuario es ADMIN (o VENTAS), mostramos el Dashboard con la barra lateral
  return (
