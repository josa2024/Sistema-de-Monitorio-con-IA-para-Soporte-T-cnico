  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 w-full py-8">
      <div>
        ...
        <p className="text-slate-500 mt-1">Visualiza los datos de los equipos activos.</p>
      </div>
      ...
      {equiposInstalados.length > 0 ? (
        ...
        <div className="bg-white p-12 rounded-2xl shadow-sm border border-slate-200 text-center text-slate-400">
          ...
          <p className="text-sm">Primero se deben registrar la recepción los equipos para ver sus garantías.</p>
        </div>
      )}
