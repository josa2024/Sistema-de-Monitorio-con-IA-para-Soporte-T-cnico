...
# 3. Set the target metadata to your app's Base model metadata
...
def run_migrations_offline() -> None:
    ...
    """
    # --- CUSTOM CONFIGURATION ---
    # 4. Use the database URL from your app's settings
...
def run_migrations_online() -> None:
    ...
    """
    # --- CUSTOM CONFIGURATION ---
    # 5. Create the engine using the app's database URL
